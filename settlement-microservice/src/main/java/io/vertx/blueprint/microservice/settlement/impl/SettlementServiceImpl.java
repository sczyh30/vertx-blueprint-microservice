package io.vertx.blueprint.microservice.settlement.impl;
...
import io.vertx.blueprint.microservice.settlement.SettlementService;
...
/**
 * A simple implementation for {@link SettlementService}.
 */
public class SettlementServiceImpl implements SettlementService {
  ...
  public SettlementServiceImpl(Vertx vertx, ServiceDiscovery discovery) {
    this.vertx = vertx;
    this.discovery = discovery;
  }

  @Override
  public SettlementService buy(String userId, List<ProductTuple> products, Handler<AsyncResult<JsonObject>> resultHandler) {
    if (userId == null) {
