...
public class ProductService {
   ...
   */
  public static ProductService createService(Vertx vertx, JsonObject config) { 
    ProductService ret = ProductService.newInstance(io.vertx.blueprint.microservice.product.ProductService.createService((io.vertx.core.Vertx)vertx.getDelegate(), config));
    return ret;
  }
